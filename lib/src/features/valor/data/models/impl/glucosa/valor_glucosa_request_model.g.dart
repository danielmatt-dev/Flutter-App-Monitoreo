...
ValorGlucosaRequestModel _$ValorGlucosaRequestModelFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ValorGlucosaRequestModelToJson(ValorGlucosaRequestModel instance) =>
    <String, dynamic>{
