...
class ConsentimientoText {
  ...
  static const justificacion = 'Le invitamos a participar en un proyecto de investigación que tiene como objetivo identificar los aspectosrelacionados con el autocuidado de la diabetes para poder ofrecer alternativas para su mejora.';
  static const procedimientos = 'Si usted acepta participar en el estudio, se le realizará un breve cuestionario para conocer su historial clínico, seincluirá en un programa de seguimiento estrecho para el control de la diabetes mediante el uso de una aplicaciónen su dispositivo móvil. Se proporcionarán sesiones individuales y grupales de asesoría y practica de cuidadode la glucosa, alimentación saludable y actividad física.';
  ...
  static const dudasParticipante = 'En caso de dudas o aclaraciones sobre sus derechos como participante podrá dirigirse a: Comité de Bioética de Investigación en Salud de la Facultad de Medicina de laUniversidad Veracruzana, Campus Cuidad Mendoza, Ver.';
