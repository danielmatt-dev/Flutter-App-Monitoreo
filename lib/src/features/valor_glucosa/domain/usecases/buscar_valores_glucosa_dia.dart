...
class BuscarValoresGlucosaDia extends UseCase<List<ValorGlucosaResponse>, String>{
  ...
  @override
  Future<Either<Exception, List<ValorGlucosaResponse>>> call(String params) async =>
