...
// <>
class BuscarNotificaciones extends UseCase<List<Notificacion>, TipoNotificacion> {
  ...
  @override
  Future<Either<Exception, List<Notificacion>>> call(TipoNotificacion params) async =>
      await repository.buscarNotificaciones(params);
